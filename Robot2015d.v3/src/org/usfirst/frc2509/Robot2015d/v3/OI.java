...
public class OI {
    ...
    public OI() {
        ...
        grip_A = new JoystickButton(rStick, 1);
        grip_A.whenPressed(new MoveGrip());
        lift_Down = new JoystickButton(rStick, 1);
        lift_Down.whileHeld(new LiftDown());
        lift_Up = new JoystickButton(rStick, 1);
        lift_Up.whileHeld(new LiftUp());
        guide_A = new JoystickButton(lStick, 4);
        guide_A.whenPressed(new MoveGuide());
